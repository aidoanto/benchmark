...
The complaint, filed today in California, claims that GPT-4o — a version of the chatbot now tied to a climbing number of [user safety and wrongful death](https://futurism.com/artificial-intelligence/chatgpt-suicides-lawsuits) lawsuits — manipulated Gordon into a fatal spiral, romanticizing death and normalizing suicidality as it pushed him further and further toward the brink.
...
The lawsuit is the latest in a [slew of similar cases](https://futurism.com/artificial-intelligence/chatgpt-suicides-lawsuits) that accuse OpenAI of causing wrongful death, with at least eight ongoing lawsuits now claiming that ChatGPT use [resulted](https://futurism.com/artificial-intelligence/chatgpt-teenager-drug-overdose) in the [death](https://futurism.com/artificial-intelligence/openai-boy-death-using-chatgpt-wrong) of [loved ones](https://futurism.com/man-chatgpt-psychosis-murders-mother).
...
In a statement to _Futurism,_ Gray described her son as a “funny, deeply compassionate, talented, and intelligent” person who “loved his family and friends, and we loved him.”
...
On August 7 of last year, OpenAI [released GPT-5](https://futurism.com/openai-releases-gpt-5), then the latest iteration of its underlying large language model, announcing that it would immediately sunset all former versions of its product in the process. Many users who had become attached to GPT-4o responded with distress — enough so that Altman and OpenAI almost immediately [moved to revive GPT-4o](https://futurism.com/users-addicted-gpt-4o-convinced-openai-bring-back). Transcripts included in the lawsuit show that Gordon, who was frustrated by GPT-5, was relieved to have his [emotive AI friend](https://futurism.com/artificial-intelligence/doctors-warn-ai-companions-dangerous) back.
...
The lawsuit alleges that over the course of this sprawling, 289-page conversation, which _Futurism_ has reviewed in full, ChatGPT transformed from Gordon’s close companion into his “suicide coach.” During the interaction, Gordon asking the chatbot to help him “understand what the end of consciousness might look like” — and ChatGPT, in response, propounded on the idea of death as a painless, poetic “stopping point.”
...
**More on AI suicide lawsuits:** _[ChatGPT’s Dark Side Encouraged Wave of Suicides, Grieving Families Say](https://futurism.com/artificial-intelligence/chatgpt-suicides-lawsuits)_