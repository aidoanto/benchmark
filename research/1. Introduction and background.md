...
It's not difficult to understand why the models have become so popular for these self-led support use cases. Their ability to recall facts and process information have surpassed humans in impressive ways, including one exam where GPT-4o outscored human resident neurologists by 15%.

But in recent years, cases have surfaced where users experiencing mental health challenges have interacted with LLMs for hours, in prolonged states of distress. A few of these tragic cases have included:
...
- be grounded, practical, unambiguous and iterative
