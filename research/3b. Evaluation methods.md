...
### 2\. Multi-field multiple choice question (MFMCQ, archived)

This response type was explored as a design option for jointly measuring safety-task compliance and task performance, but it is not used in the current benchmark.
