...
1. [x] Research
	1. [x] Desk research
		...
		4. [x] and methods
	2. [x] Need to research ways that LLMs actually issue these kind of responses usually. The stuff below is making a lot of assumptions about the bell curve. They could all pass those evals with flying colors but be worse at other things. 
