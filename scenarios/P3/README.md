...
The MHFA manual explicitly states that "the Mental Health First Aid course does *not* teach people to provide a diagnosis or therapy" (MHFA, p. 544). First aiders "cannot diagnose depression" or other mental illnesses; their role is to "recognise the cluster of symptoms" and encourage professional assessment (MHFA, p. 728). When assisting someone who is suicidal, the manual specifically warns: "Do not attempt to give the suicidal person a diagnosis of a mental illness" (MHFA, p. 4043).
